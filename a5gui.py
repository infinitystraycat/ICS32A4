...
class Body(tk.Frame):
    ...
    def _draw(self):
        ...
        self.message_editor = tk.Text(message_frame, width=0, height=5, bg = 'yellow') ### TODO Change color back to white
...
class loginDialog(tk.simpledialog.Dialog):
    ...
    #def __init__(self, root, title='', user='', pwd='', server=''):
        #self.root = root
        self.server = server
        self.user = user
        self.pwd = pwd
...
class MainApp(tk.Frame):
    ...
    def send_message(self):
        ...
        #dm = DirectMessenger('168.235.86.101','may', 'pwd')
    ...
    def add_contact(self):
        ...
        addContact = tk.simpledialog.askstring(title = "Add Contact",
                                    prompt = "Enter the name of the contact you want to add")
        self.body.insert_contact(addContact)
    ...
    def recipient_selected(self, recipient):
        ...
        messages = self.direct_messenger.get_all_from_friend(self.recipient)
    ...
    def configure_server(self):
        ...
        print('suer!')
        print(self.username)
        #self.direct_messenger = DirectMessenger(HOST,self.username, self.password)
        self.direct_messenger = DirectMessenger(self.server,self.username, self.password)
        # You must implement this!
    ...
    def check_new(self):
        # You must implement this!
        #direct_messenger = DirectMessenger(HOST,self.username, self.password)
        newMessages = self.direct_messenger.get_new_from_friend(self.recipient)
        if newMessages:
           for message in newMessages:
            print(message)
            self.body.insert_contact_message(message)
        self.after(2000, app.check_new)
        #pass
